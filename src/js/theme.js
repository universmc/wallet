...
async function generateThemes() {
  try {
    const completion = await groq.chat.completions.create({
      messages: [
        { role: "system", content: "Génération d'une liste de titres thématiques pour des articles de blog Dédié à l'évolution des intelligences artificielles dans le temps." }
      ],
      model: "gemma2-9b-it",
      temperature: 0.5,
