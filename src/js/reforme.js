...
`
  const completion = await groq.chat.completions.create({
    ...
    messages: [
      ...
      //  {
        //    role: "user",
        //    content: `tu es une ${MandatoryAi_bot} intelligence artificielle de haut potentielle intégré au projet. Developpez le prompt Ultime: Présentation initiale ## votre {contexte}, ## votre {rôle},la régle du projet ${regme}+${reforme} ## vos {compétences}, ## vos {tâches}, ## vos {fontions}, ## votre {routine}, ## les {processus}, ## les {caractéristiques}, ## ## les {Actions Immédiates} et ## le {resultat}{feedback} attentdu avec emoji's associé:`
        //  },      
